...
public class Occupation1 extends AppCompatActivity {
    ...
    public boolean  onCreateOptionsMenu(Menu menu) {
        ...
        SubMenu menu4=menu.addSubMenu(0,3,Menu.NONE,"服　事");
        SubMenu menu5=menu.addSubMenu(0,4,Menu.NONE,"商　人");
        SubMenu menu6=menu.addSubMenu(0,5,Menu.NONE,"弓箭手");
        SubMenu menu7=menu.addSubMenu(0,6,Menu.NONE,"跆拳家");
        SubMenu menu8=menu.addSubMenu(0,7,Menu.NONE,"跆拳家");
        SubMenu menu9=menu.addSubMenu(0,8,Menu.NONE,"忍　者");
        SubMenu menu10=menu.addSubMenu(0,8,Menu.NONE,"神槍手");
        ...
        menu4.add(4,1,Menu.NONE,"祭　司");
        menu4.add(4,2,Menu.NONE,"神　官");
        menu4.add(4,3,Menu.NONE,"大主教");
        menu4.add(4,4,Menu.NONE,"2-2職業");
        menu4.add(4,5,Menu.NONE,"武道家");
        menu4.add(4,6,Menu.NONE,"武術宗師");
        menu4.add(4,7,Menu.NONE,"修　羅");
        ...
        menu6.add(6,1,Menu.NONE,"鐵　匠");
        menu6.add(6,2,Menu.NONE,"神工匠");
        menu6.add(6,3,Menu.NONE,"機械工匠");
        menu6.add(6,4,Menu.NONE,"2-2職業");
        menu6.add(6,5,Menu.NONE,"鍊金術師");
        menu6.add(6,6,Menu.NONE,"創造者");
        menu6.add(6,7,Menu.NONE,"基因學者");
        ...
        menu7.add(7,5,Menu.NONE,"詩人(男)");
        menu7.add(7,6,Menu.NONE,"舞孃(女)");
        menu7.add(7,7,Menu.NONE,"藝人(男)  ");
        menu7.add(7,8,Menu.NONE,"舞姬(女)");
        menu7.add(7,9,Menu.NONE,"宮廷樂師(男)");
        menu7.add(7,10,Menu.NONE,"浪跡舞者(女)");
